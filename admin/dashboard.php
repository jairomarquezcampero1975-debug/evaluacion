...
<body class="admin-body">
    ...
    <div class="admin-shell">
        ...
        <aside class="admin-sidebar">
            ...
            <a class="admin-link active" href="dashboard.php">
            ...
            <div class="mini-badge">
                <i class="bi bi-shield-check"></i> Rutas protegidas
            </div>

            <div class="mini-badge">
                <i class="bi bi-lock"></i> Rol admin
            </div>
        </aside>
                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-8">
                        <span class="mini-badge">
                            <i class="bi bi-stars"></i> Administracion profesional
                        </span>
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="metric-card metric-blue">
                        ...
                        <a class="btn btn-outline-light btn-sm align-self-start" href="productos.php">
                            Gestionar
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="metric-card metric-green">
                        ...
                        <a class="btn btn-outline-light btn-sm align-self-start" href="categorias.php">
                            Gestionar
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="metric-card metric-purple">
                        ...
                        <a class="btn btn-outline-light btn-sm align-self-start" href="usuarios.php">
                            Ver usuarios
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="metric-card metric-orange">
                        ...
                        <a class="btn btn-outline-light btn-sm align-self-start" href="ventas.php">
                            Ver ventas
                        </a>
                    </div>
                </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <div class="price mb-2">
                                Bs <?php echo number_format($ingresos, 2); ?>
                            </div>

                            <p>Total de ventas no canceladas.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <a href="stock.php" class="btn btn-danger">
                                Revisar stock
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tr>
                                ...
                                <td>
                                    Bs <?php echo number_format($v['total'], 2); ?>
                                </td>

                                <td>
                                    <span class="badge bg-info">
                                        <?php echo e($v['estado_venta']); ?>
                                    </span>
                                </td>
                            </tr>
